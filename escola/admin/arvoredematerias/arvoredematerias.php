...
<?php
    ...
    if(isset($_GET['confirm'])){
        ...
        if(isset($materia) && !empty(trim($materia))){
            ...
            $sql2 = "DELETE FROM notas WHERE materia='$materiaid';";
...
<body>
    ...
    <div class="popup" id="popup">
        <div class="popupbox">
        <span>Você tem certeza que deseja deletar essa matéria? Ao deletar vocẽ removerá todos os dados associados a mesma.</span>  
            <div class="buttons">
  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293 5.354 4.646z"/>
    ...
    <?php 
        if(isset($_GET['popup'])){
            ...
            const button = document.getElementById("deletar");
            ...
            echo 'cancelar.onclick = () =>{
                var url = window.location.href;
                window.location.href = "arvoredematerias.php";
            }';
            echo '</script>';
        }
    ?>
