        ...
        if(isset($_GET['busca']) && !empty($_GET['busca'])){
            ...
            if(mysqli_num_rows($result_busca) > 0){
                while($row_busca = mysqli_fetch_assoc($result_busca)){
                    ...
                    echo "</td>";
                    echo '<td><a href="aluno.php?delete='. $row_busca["matricula"] .'"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo $row['segmento'];
                echo "</td>";
                echo '<td><a href="aluno.php?delete='. $row["matricula"] .'"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                    <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
                </svg></a></td>';
