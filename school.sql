...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02-Nov-2023 às 02:18
...
INSERT INTO `alunos` (`nome`, `login`, `senha`, `matricula`, `turma`, `serie`, `segmento`) VALUES
('Enzo Evangelista D\'Andrea Salvador', 'Enzo', '$2y$10$Tf8Zm2wAbwNp6nNRIxEvxuCE8gkCrNkgCc7HUEkHPqVrNUaaa9DRq', 17, '1301', '1', 'teste'),
('mae maemae', 'mae1', '$2y$10$hauTlI6pIjae/tYQiqNoy.yE0yDeJr.Vpnw3OANZcaiUelniRaNNi', 16, '1301', '1', 'teste');
...
(4, 'asdsadsa', '$2y$10$Xj9kPbUm/AbP/baOYQZok.mix3elbX2KNr6vhDWsypEl0wESMEeNW'),
(3, 'teste1212', '$2y$10$YXmYf67C5W6Z7X1SKdYuQ.mbBEc68QqDQIjSflUwNEqX3L1tk/WIG');
...
--
ALTER TABLE `alunos`
  MODIFY `matricula` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
